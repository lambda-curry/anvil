...
Checked-in audit packet: `docs/audits/anvil-audit-2026-07-29.md`
...
- a fresh `bun run audit --target . --ci` rerun still matches `docs/audits/anvil-audit-2026-07-29.md` after normalizing expected date-stamped metadata
